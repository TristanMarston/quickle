...
const Statistics = () => {
    ...
    const { prevGames, setPrevGames, setModalOpened, shownStats, formattedStats, setFormattedStats, selectedLength } = context;
    ...
    */
    ...
    }, [prevGames, shownStats, selectedLength]);
            ...
            <div className='flex flex-col gap-2 mb-4'>
                ...
                {formattedStats.guessNumbers.slice(0, 6).map((amount, index) => (
                    <div className={`${fredokaLight.className} flex gap-2 items-center`} key={index + amount + generateID(index * 2)}>
                        {' '}
                        {/* had an issue with duplicate keys, had to use generateID to stop multiple from rendering */}
